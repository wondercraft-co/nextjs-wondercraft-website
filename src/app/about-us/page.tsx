            ...
            <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
              ...
              <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
                <p className="text-lg leading-8 text-gray-600">
                  ...
                  magic wand, empowering users to solve problems and giving
                  brands a sleek, impressive edge. Above all, it&apos; s the
                  sheer joy of making people happy through our work that drives
                  us forward.
                </p>
              </div>
              <Image
              ...
              <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                ...
                <div className="mt-10 max-w-xl text-base leading-7 text-gray-700">
                  ...
                  <p className="mt-10">
                    ...
                    Ultimately, our clients&apos; triumphs are our own, and
                    their unwavering trust is the beacon that guides our path
                    forward.
                  </p>
                </div>
              </div>
            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center lg:gap-y-0">
              <div className="lg:row-start-2 lg:max-w-md">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-300">
                  At the heart of our team&apos;s ethos lies a deep commitment
                  to a set of guiding principles that define not only how we
                  work, but who we are. These values serve as the foundation of
                  our every endeavor, shaping our interactions, decisions, and
